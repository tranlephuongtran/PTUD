        ...
        <div class="row">
            <div class="col-md-5 mb-5 mb-md-0">
                <div class="p-2 p-lg-4 border bg-white">
                    <div class="row">
                        <img src="layout/images/<?php echo htmlspecialchars($product['hinhAnh']); ?>" style="width: 485px;height: 561px;" class="img-fluid product-thumbnail">
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <form method="post">
                                <button type="submit" name="add_to_cart" class="btn btn-primary mt-4 mb-4" style="border-radius: 10px;">
                                    <img src="layout/images/cart.svg"> Thêm Vào Giỏ Hàng
                                </button>
                            </form>
                        </div>
                        <div class="col-md-4">
                            <button class="btn btn-primary mt-4 mb-4" onclick="window.location='shop/index.php'" style="border-radius: 10px;">Quay về</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-7">
                <div class="col-md-12">
                    <div class="p-2 p-lg-4 border bg-white">
                        ...
                        <h4 class="text-success">Giá thuê: <b><?php echo number_format($product['giaThue'], 0, '.', '.'); ?> VND</b></h4>
                        <h4 class="text-success">Tiền cọc: <b><?php echo number_format($product['tienCoc'], 0, '.', '.'); ?> VND</b></h4>
                        <div class="mb-3">
                ...
                <div class="col-md-12 mt-2">
                    <div class="p-2 p-lg-4 border bg-white">
                        ...
                        <table class="table site-block-order-table mb-3">
                            <tbody>
                                <tr><td class="font-weight-bold">Mã ISBN</td><td class="text-black"><strong><?php echo htmlspecialchars($product['maISBN']); ?></strong></td></tr>
                                <tr><td class="font-weight-bold">Tác giả</td><td class="text-black"><strong><?php// echo htmlspecialchars($product['tacGia']); ?></strong></td></tr>
                                <tr><td class="font-weight-bold">Danh mục</td><td class="text-black"><strong><?php echo htmlspecialchars($product['danhmuc']); ?></strong></td></tr>
                                <tr><td class="font-weight-bold">Ngày xuất bản</td><td class="text-black"><strong><?php echo htmlspecialchars($product['ngayXB']); ?></strong></td></tr>
                                <tr><td class="font-weight-bold">Nhà xuất bản</td><td class="text-black"><strong><?php// echo htmlspecialchars($product['nhaXuatBan']); ?></strong></td></tr>
                                <!--<script>
