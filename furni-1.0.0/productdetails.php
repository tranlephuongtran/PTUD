        ...
        <div class="row">
            <div class="col-md-5 mb-5 mb-md-0">
                <div class="p-2 p-lg-4 border bg-white ">
                    <div class="row">
                        <img src="images/CayCamNgotCuaToi.png" style="width: 485px;height: 561px;"
                            class="img-fluid product-thumbnail">
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <button class=" btn btn-primary mt-4 mb-4 " onclick="window.location='#'"
                                style="border-radius: 10px;"><img src="images/cart.svg"> Thêm
                                Vào Giỏ Hàng</button>
                        </div>
                        <div class="col-md-4">
                            <button class=" btn btn-primary mt-4 mb-4" onclick="window.location='#'"
                                style="border-radius: 10px;">Quay
                                về</button>
                        </div>
            ...
            <div class="col-md-7">
                <div class="col-md-12">
                    <div class="p-2 p-lg-4 border bg-white">
                        ...
                        <h4 class="text-success">Giá thuê: <b>17.000 VNĐ</b></h4>
                        <h4 class="text-success">Tiền cọc: <b>17.000 VNĐ</b></h4>
                        <div class="mb-3">
