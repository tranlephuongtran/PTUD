            ...
            <div class="col-lg-8">
                <div class="subscription-form">
                    <h3 class="d-flex align-items-center"><span class="me-1"><img src="images/envelope-outline.svg"
                                <<<<<<< HEAD <<<<<<< HEAD alt="Image" class="img-fluid"></span><span>Liên hệ với
                            chúng tôi</span></h3>
                    ...
                    <form action="#" class="row g-3">
                        ...
                        <div class="col-auto">
                            ...
                            <form action="#" class="row g-3">
                                ...
                                <div class="col-auto">
                                    <<<<<<< HEAD <input type="email" class="form-control"
                ...
                <div class="row pt-4">
                    <div class="col-lg-6">
                        <p class="mb-2 text-center text-lg-start">Copyright &copy;
                            ...
                            <<<<<<< HEAD <<<<<<< HEAD Designed with love by A Plus. Distributed By A Plus=======Designed
